...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="view/content/styles/gabaritCSS.css" />
    <link rel="stylesheet" type="text/css" href="view/content/styles/loginMenuCSS.css" />
</head>
<body id="pageBody">
<div class="Login">
    <?php echo @$_SESSION['Username'];
    if (isset($_SESSION['Username'])) : ?>
        <?php ?> <a href="index.php?action=logout">Log Out</a><?php
    else : ?>
        <a href="index.php?action=login">Login</a> | <a href="index.php?action=register">Register</a>
    <?php endif ?>
</div>
        ...
        <div class="divPanel">
            ...
            <div class="row-fluid">
                ...
                <div class="span3" id="footerArea2">
                    ...
                    <p>
                        <a href="#" title="i">Le Burton B221 est à disposition</a><br/>
