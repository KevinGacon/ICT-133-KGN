...
{
    $msgAfter= prepareMsgToWrite($msg[1],$msg[0]);
    writeMsgInFile($fileFullPath, $msgAfter, false);
}
//</editor-fold>
...
function prepareMsgToWrite($msg, $levelNumber)
{
	...
	*/
    ...
    $log = convertLevelIntToDescription($levelNumber);

    $msgAfter = $timeStamp."\t".$log."\t".$msg;
